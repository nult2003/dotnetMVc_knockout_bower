...
(function (WebAppWithBower1) {
    ...
    (function (Product) {
        var ProductVM = /** @class */ (function (_super) {
            ...
            return ProductVM;
        }(WebAppWithBower1.Shared.RootViewModel));
        Product.ProductVM = ProductVM;
        function asyncReadJson() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productJson.readJson()];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        }
    })(Product = WebAppWithBower1.Product || (WebAppWithBower1.Product = {}));
